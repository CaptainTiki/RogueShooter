...
@export_range(-90,-60) var tilt_lower_limit : int = -90 #in degrees
@export_range(60,90) var tilt_upper_limit : int = 90 #in degrees
@export_group("Crouch Vertical Movement")
@export var crouch_offset : float = 1.0
